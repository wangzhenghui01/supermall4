<template>
  <div>
    <body>
      ...
      <header>
        <h1>数据可视化-ECharts</h1>
        <div class="showNowTime">{{left_button}}</div>
      </header>
     <!--页面主题部分-->
       ...
       <div class="column">
         <div class="panel bar">
           <div class="panel-header">
             <a-button type="primary" :class="left_button ? left_button_1 : left_button_2" @click="btnClick">
               销售笔数
             </a-button>
             <a-button type="primary" :class="!left_button ? left_button_1 : left_button_2" @click="btnClick">
               销售金额
...
<script>
  // import {getChargeTypeProportion} from '@/network/home'
  export default {
    name: "Home",
    data() {
      return {
    ...
    methods: {
      ...
      myLeftChart1(){
        ...
        let mychart = this.$echarts.init(this.$refs.leftCart1)
        // 指定配置和数据
        let option = {
          title:{
            show:true,
          ...
          series: [
            ...
            },
            {
              ...
              type: "bar",
              barWidth: "20%",
              data: [100, 200, 400, 600, 1100, 1500, 700]
            }
          ]
        };
        // 把配置给实例对象
